...
/* This file provides the newlib/Picolibc syscall layer used by the GCC build.
 * Keil ARMCC/ArmClang uses its own C library retarget layer and must not compile
 * these declarations (notably the unavailable <sys/stat.h> header). */
...
#endif /* GCC newlib/Picolibc build */
